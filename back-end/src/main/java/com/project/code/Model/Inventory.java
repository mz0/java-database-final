...
public class Inventory {
    ...
    @JsonBackReference("inventory-product") // prevent circular references during JSON serialization
    private Product product;

    @ManyToOne @JoinColumn(name = "store_id")
    @JsonBackReference("inventory-store") // prevent circular references during JSON serialization
    private Store store;
